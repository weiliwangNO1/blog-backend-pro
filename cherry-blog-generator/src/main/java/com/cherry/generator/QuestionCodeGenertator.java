...
public class QuestionCodeGenertator {

    // 生成的代码放到哪个工程中
    private static String PROJECT_NAME = "cherry-blog-question";
    ...
    public static void main(String[] args) {
        ...
        gc.setAuthor("维利博客-weiliwang.top");
        ...
        pc.setParent("com.cherry.blog"); //父包名
        pc.setController(MODULE_NAME+".controller"); // com.cherry.blog.aritcle.controller
        ...
        pc.setEntity("entities");//实体类存储包名 com.cherry.blog.entities
